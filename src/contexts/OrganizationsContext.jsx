...
import {
    unauthorizedDashboardAxiosInstance, authorizedCiderAxiosInstance
...
export const OrganizationsProvider = ({children}) => {
    ...
    const fetchOrganization = async ({organizationId}) => {
        try {
            const response = await authorizedCiderAxiosInstance.get(`/organizations/organization_id/${organizationId}`);
